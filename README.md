...
- [x] **Stores data in MongoDB** - Scores, Graph Data, and Average Time are all stored in MongoDB.
- [x] **Stores credentials in MongoDB** - Usernames and Hashed passwords are stored in MongoDB.
